...
connection = pymysql.connect(host='localhost',user='root',password='admin',db='resume')
...
def run():
    ...
    link = '[©Developed by Ms.SANIA SARDAR, KAVITHA M](https://www.linkedin.com/in/saubansamith)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'mr' and ad_password == 'dominators':
                st.success("Welcome Ms Sania Sardar, Kavitha M")
                # Display Data
